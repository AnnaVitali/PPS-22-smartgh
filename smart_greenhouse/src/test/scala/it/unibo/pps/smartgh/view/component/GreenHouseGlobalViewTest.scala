...
/** This class contains the tests to verify that the [[GreenHouseGlobalView]] work correctly. */
...
class GreenHouseGlobalViewTest extends AbstractViewTest:
  ...
  private def start(stage: Stage): Unit =
    ...
    startApplication(stage, baseView, GreenHouseGlobalView(null, baseView))
